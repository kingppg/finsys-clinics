...
**Deferred / future:** CSV export of filtered view; dentist column; theme picker in Clinic Config; additional themes; prune unused deps (highcharts — commercial license, shadcn-ui npm package, recharts, tailwind); Playwright E2E; backfill formal `invoice_number` sequence (BIR consideration).
